...
Revision ID: 76ab1e7d47ea
Revises: 
Create Date: 2024-06-01 19:35:25.189347
...
def upgrade() -> None:
    ...
    sa.Column('centro_treinemanto_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['categoria_id'], ['categorias.pk_id'], ),
    sa.ForeignKeyConstraint(['centro_treinemanto_id'], ['centros_treinamento.pk_id'], ),
    sa.PrimaryKeyConstraint('pk_id'),
